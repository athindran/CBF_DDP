...
from simulators.costs.oneplayer.base_margin import BaseMargin, SoftBarrierEnvelope
from simulators.costs.oneplayer.obs_margin import CircleObsMargin
from simulators.costs.oneplayer.quadratic_penalty import QuadraticControlCost
from simulators.costs.oneplayer.half_space_margin import LowerHalfMargin, UpperHalfMargin
...
class Bicycle5DBasicConstraintMargin( BaseMargin ):
  ...
  def get_target_stage_margin(
    ...
    for _target_constraint in self.target_constraint:
      ...
      cost = -1*_target_constraint.get_stage_margin(state, ctrl)
