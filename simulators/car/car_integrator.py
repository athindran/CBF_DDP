...
from .integrator4d_margin import IntegratorReachability2DMargin
from ..base_single_env import BaseSingleEnv

class CarIntegrator4DEnv(BaseSingleEnv):
  # region: init
  def __init__(self, config_env, config_agent, config_constraint) -> None:
    ...
    if self.cost_type=="Reachability":
      self.cost = IntegratorReachability2DMargin(config_constraint, self.agent.dyn)
